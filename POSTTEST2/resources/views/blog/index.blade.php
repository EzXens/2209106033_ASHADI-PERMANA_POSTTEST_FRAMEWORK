...
<div class="relative">
  <div class="flex gap-4 overflow-x-auto pb-4 scroll-smooth snap-x snap-mandatory" id="fallAnime">
    {{-- Card 1 --}}
    <div class="min-w-[200px] snap-start">
      <div class="relative group rounded-lg overflow-hidden shadow-lg transform transition duration-500 hover:scale-110 hover:translate-x-2  hover:z-10">
        <img src="image/cover_image/opm3.jpg" alt="Anime 1"
    ...
    <div class="min-w-[200px] snap-start">
      <div class="relative group rounded-lg overflow-hidden shadow-lg transform transition duration-500 hover:scale-110 hover:translate-x-2  hover:z-10">
        <img src="image/cover_image/spyxfamily.jpg" alt="Anime 2"
             class="w-full h-72 object-cover">
        <div class="absolute bottom-0 inset-x-0 bg-black/60 text-white text-center p-2">
    ...
    <div class="min-w-[200px] snap-start">
      <div class="relative group rounded-lg overflow-hidden shadow-lg transform transition duration-500 hover:scale-110 hover:translate-x-2  hover:z-10">
        <img src="image/cover_image/mha.jpg" alt="Anime 3"
             class="w-full h-72 object-cover">
        <div class="absolute bottom-0 inset-x-0 bg-black/60 text-white text-center p-2">
    ...
    <div class="min-w-[200px] snap-start">
      <div class="relative group rounded-lg overflow-hidden shadow-lg transform transition duration-500 hover:scale-110 hover:translate-x-2  hover:z-10">
        <img src="image/cover_image/fumetsu.jpg" alt="Anime 3"
             class="w-full h-72 object-cover">
        <div class="absolute bottom-0 inset-x-0 bg-black/60 text-white text-center p-2">
    ...
    <div class="min-w-[200px] snap-start">
      <div class="relative group rounded-lg overflow-hidden shadow-lg transform transition duration-500 hover:scale-110 hover:translate-x-2  hover:z-10">
        <img src="image/cover_image/tomodachi.jpg" alt="Anime 3"
             class="w-full h-72 object-cover">
        <div class="absolute bottom-0 inset-x-0 bg-black/60 text-white text-center p-2">
    ...
    <div class="min-w-[200px] snap-start">
      <div class="relative group rounded-lg overflow-hidden shadow-lg transform transition duration-500 hover:scale-110 hover:translate-x-2  hover:z-10">
        <img src="image/cover_image/nageki.jpg" alt="Anime 3"
             class="w-full h-72 object-cover">
        <div class="absolute bottom-0 inset-x-0 bg-black/60 text-white text-center p-2">
    ...
    <div class="min-w-[200px] snap-start">
      <div class="relative group rounded-lg overflow-hidden shadow-lg transform transition duration-500 hover:scale-110 hover:translate-x-2  hover:z-10">
        <img src="image/cover_image/shuumatsu.jpg" alt="Anime 3"
             class="w-full h-72 object-cover">
        <div class="absolute bottom-0 inset-x-0 bg-black/60 text-white text-center p-2">
          shuumatsu no walkure III
        </div>
      </div>
    </div>
  </div>
...
<div class="relative">
  <div class="flex gap-4 overflow-x-auto pb-4 scroll-smooth snap-x snap-mandatory" id="popularAnime">
    {{-- Card 1 --}}
    <div class="min-w-[200px] snap-start">
      <div class="relative group rounded-lg overflow-hidden shadow-lg transform transition duration-500 hover:scale-110 hover:translate-x-2   hover:z-10">
        <img src="https://i.ibb.co/2hzX94p/anime-card1.jpg" alt="Anime 1"
             class="w-full h-72 object-cover">
        <div class="absolute bottom-0 inset-x-0 bg-black/60 text-white text-center p-2">
          Jujutsu Kaisen
        </div>
    ...
    <div class="min-w-[200px] snap-start">
      <div class="relative group rounded-lg overflow-hidden shadow-lg transform transition duration-500 hover:scale-110 hover:translate-x-2  hover:z-10">
        <img src="https://i.ibb.co/ZccgLVk/anime-card2.jpg" alt="Anime 2"
             class="w-full h-72 object-cover">
        <div class="absolute bottom-0 inset-x-0 bg-black/60 text-white text-center p-2">
          One Piece
        </div>
    ...
    <div class="min-w-[200px] snap-start">
      <div class="relative group rounded-lg overflow-hidden shadow-lg transform transition duration-500 hover:scale-110 hover:translate-x-2  hover:z-10">
        <img src="https://i.ibb.co/V3Hqzj8/anime-card3.jpg" alt="Anime 3"
             class="w-full h-72 object-cover">
        <div class="absolute bottom-0 inset-x-0 bg-black/60 text-white text-center p-2">
          Naruto Shippuden
        </div>
